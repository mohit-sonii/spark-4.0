...
*/
    ...
    public static void main(String[] args) {
        try {
            ...
            /*
            SCROLL_INSENSITITVE -> means when a request is made to db it will fetch that curernt data and keep a cache menaing that if any change occur in daabase we won't be able to see that -> NO LIVE UPDATE
